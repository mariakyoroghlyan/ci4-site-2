                ...
                <div class="table-responsive">
                    <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5 dataTable no-footer" aria-describedby="kt_datatable_zero_configuration_info">
                        ...
                        <tr class="fw-bold fs-6 text-gray-800 px-7">
                            ...
                            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_datatable_zero_configuration" rowspan="1" colspan="1" aria-label="Description: activate to sort column ascending" style="width: 181.797px;">Location</th>
                            ...
                            <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_datatable_zero_configuration" rowspan="1" colspan="1" aria-label="Type: activate to sort column ascending" style="width: 151.812px;">Square</th>
                            <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_datatable_zero_configuration" rowspan="1" colspan="1" aria-label="Category: activate to sort column ascending" style="width: 151.812px;">Show in slider</th>
                            <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_datatable_zero_configuration" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 151.812px;">Category</th>
                            <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_datatable_zero_configuration" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 151.812px;">Information</th>
                        ...
                        <tr class="even">
                            <td class="sorting_1"><?= $project['title'] ?></td>
                                <td><img src="<?= $project['image'] ?>" width="100px" alt="img"></td>
                            <td><?= $project['location'] ?></td>
                            <td><?= $project['date'] ?></td>
                            <td><?= $project['square'] ?></td>
                            <td><div class="badge badge-light-success"><?= $project['show'] == 1 ? 'Active' : 'Inactive' ?></div></td>
                            <td><?= $project['category'] ?></td>
                            <td>
                                <?= strlen($project['information']) > 15 ? esc(substr($project['information'], 0, 15)) . '...' : esc($project['information']) ?>
                            </td>
                            <td>
